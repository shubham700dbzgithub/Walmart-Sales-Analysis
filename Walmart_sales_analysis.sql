...
select distinct(payment), count(*) as pay_count
from sales
group by payment
order by pay_count desc;

-- What is the most selling product line?
select product_line, count(product_line) as prod_count
from sales
...
select customer_type, count(*) as most_buying_cust
from sales 
group by customer_type
order by most_buying_cust desc;
